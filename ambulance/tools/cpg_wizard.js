      ...
      <div class="cw-panel">
        <div class="cw-row">
          <div class="cw-input" style="flex: 2 1 320px;">
            <input id="cwQuery" type="search" inputmode="search" placeholder="Search symptoms, drugs, abbreviations…" autocomplete="off" />
    ...
    if (res.length) {
      ...
      res.forEach((x) => {
        ...
        card.innerHTML = `
          ...
          <div class="cw-right">
            <div class="cw-acc ${pctCls}">${pct != null ? `${pct}%` : `—`}</div>
